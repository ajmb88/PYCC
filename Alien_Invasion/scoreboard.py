...
class Scoreboard:
    """ A class to record scring information."""
    ...
    def prep_high_score(self):
        ...
        # Center the high score in the top middle of the screen.
        self.high_score_rect = self.high_score_image.get_rect()
        self.high_score_rect.centerx = self.screen_rect.centerx
        self.high_score_rect.top = self.score_rect.top

        # Writes the new high score to the file when it is beaten.
        with open(filename, 'w') as high_score_number:
            high_score_number.write(str(high_score))
