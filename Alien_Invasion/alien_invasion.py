...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        # Create an alien and find the number of aline in a row.
        # The spacing between aliens is equal to one alien width.
        alien = Alien(self)
    ...
    def _update_bullets(self):
        ...
        # Delete olf bullets that reach the top of the screen.
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove and bullets and aliens that collide
    ...
    def _check_fleet_edges(self):
        """ Respond appropriately if any of the aliens in the fleet hit the edge."""
    ...
    def _check_aliens_bottom(self):
        ...
        screen_rect = self.screen.get_rect()
        print(f"screen btm {screen_rect.bottom}\n")
        for alien in self.aliens.sprites():
            print(f"alien bottom: {alien.rect.bottom}\n")
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat the same as if ship was hit.
                print(f"bottom touched\n")
                self._ship_hit()
    ...
    def _check_play_button(self, mouse_pos):
        """ Start the new game when the player presses play."""
    ...
    def _start_game(self):
        """ Code to reset the game attributes."""
...
if __name__ == '__main__':
    # Make an game instance and run the game.
    ai = AlienInvasion()
    ai.run_game()
